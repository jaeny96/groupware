...
//	public List<Schedule> findByMonth(Employee skd_e, String smonth, String emonth) throws FindException{
//		List<Schedule> list = findByDate(skd_e, smonth, emonth);
//		for(Schedule sc: list) {
//			SimpleDateFormat sd = new SimpleDateFormat("yyyy-MM-dd");
//			Date d;
//			try {
//				d = sd.parse(smonth);
//				Timestamp month = new Timestamp(d.getTime());
//				month = sc.getSkd_start_date();
//			} catch (ParseException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}		
//			
//			YearMonth yearmonth = YearMonth.from(LocalDate.parse(smonth, DateTimeFormatter.ofPattern("yyyy-MM")));
//			if(smonth != null) {
...
//		}
//		
//		return dao.skdPeriodList(skd_e, smonth, emonth);
//	}
