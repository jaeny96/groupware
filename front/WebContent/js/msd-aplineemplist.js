$(function () {
  ...
  var msdLineBtnObj = document.querySelector("button.apLineMsd");
  ...
  var backurlMsdEmpList = "/back/showaplinestafflist";

  $.ajax({
    url: backurlMsdEmpList,
    method: "get",
    data: {
      apLineDeptName: msdLineBtnObj.innerText.trim(),
    },
