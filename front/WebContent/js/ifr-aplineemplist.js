$(function () {
  ...
  var tbody = document.querySelector(".IFRTbody");
  var ifrLineBtnObj = document.querySelector("button.apLineIfr");
  ...
  var backurlIfrEmpList = "/back/showaplinestafflist";

  $.ajax({
    url: backurlIfrEmpList,
    method: "get",
    data: {
      apLineDeptName: ifrLineBtnObj.innerText.trim(),
    },
