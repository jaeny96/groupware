$(function () {
  ...
  var tbody = document.querySelector(".BINTbody");
  var binLineBtnObj = document.querySelector("button.apLineBin");
  ...
  var backurlBinEmpList = "/back/showaplinestafflist";

  $.ajax({
    url: backurlBinEmpList,
    method: "get",
    data: {
      apLineDeptName: binLineBtnObj.innerText.trim(),
    },
