$(function () {
  ...
  var tbody = document.querySelector(".SALTbody");
  var salLineBtnObj = document.querySelector("button.apLineSal");
  ...
  var backurlSalEmpList = "/back/showaplinestafflist";

  $.ajax({
    url: backurlSalEmpList,
    method: "get",
    data: {
      apLineDeptName: salLineBtnObj.innerText.trim(),
    },
