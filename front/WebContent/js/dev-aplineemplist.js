$(function () {
  ...
  var tbody = document.querySelector(".DEVTbody");
  var devLineBtnObj = document.querySelector("button.apLineDev");
  ...
  var backurlDevEmpList = "/back/showaplinestafflist";

  $.ajax({
    url: backurlDevEmpList,
    method: "get",
    data: {
      apLineDeptName: devLineBtnObj.innerText.trim(),
    },
