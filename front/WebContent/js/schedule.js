...
//검색 드롭다운메뉴
var searchBtnSkdObj = document.querySelector("button#searchBtnSKD");
var $searchBtnSkdObj = $("button#searchBtnSKD");
console.log($searchBtnSkdObj);
var categoryObj = document.querySelector("div#skdSearchDropDown");
var $categoryObj = $("div#skdSearchDropDown");
var dropdownItem = categoryObj.querySelector(".dropdown-item");
